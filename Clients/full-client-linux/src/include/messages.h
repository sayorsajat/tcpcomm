...
inline string createDirectMessage(string destHost, string body, string topic, string srcHost) {
    return "/dst " + destHost + "/body " + body + "/topic " + topic + "/hst " + srcHost + "/type direct/nof";
};
inline string createBroadcastMessage(string body, string topic, string srcHost) {
    return "/body " + body + "/topic " + topic + "/hst " + srcHost + "/type broadcast/nof"; 
};
inline string createRegMessage(string srcHost, string topic) {
